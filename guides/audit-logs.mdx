...
```bash
curl "https://auth.mgpass.net/api/audit?page=1&limit=50" \
...
Audit logs are retained in the primary database indefinitely. For compliance requirements, logs can be exported via the developer console.

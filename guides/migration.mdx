...
- Use feature flags to route a percentage of traffic to mgPass
...
Rewards data migration is straightforward since it lives in the primary database:
...
2. Import it into mgPass via the developer console
...
- Developer console shows all users and data

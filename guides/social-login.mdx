...
sequenceDiagram
    ...
    App->>mgPass: Redirect to /authorize (social hint)
...
4. Configure the connector in the mgPass developer console with the client ID and secret
...
5. Configure the connector in the mgPass developer console
...
4. Configure the connector in the mgPass developer console
